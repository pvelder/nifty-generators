class NiftyNestedScaffoldGenerator < Rails::Generator::Base
  attr_accessor :parent, :name, :attributes, :controller_actions
  ...
  def manifest
    record do |m|
      ...
      unless options[:skip_controller]
        ...
        logger.route "map.resources :<%= parent_plural_name %>, :has_many => [:<%= plural_name %>]"
